...
public:
  ...
  int Joystick_Input(float &Extrn_K, float &Extrn_CosO, float &Extrn_SinO);   // Complete Input Function, Gives Amplitude Factor(K), Angles(CosO & SinO)
  virtual void Initialise(); 
  int Update(); 
  int Joystick_Get(float &Extrn_K, float &Extrn_CosO, float &Extrn_SinO); 
